  ...
  onSubmit = (e) => {
    ...
    .then(res => {
        if (res.data.msg === "Added") {
            sessionStorage.setItem("admin-message", "Successfully Added Legal Status");
    ...
    return (
      <form className="col-md-9 container text-light" onSubmit={this.onSubmit}>
        ...
        <div className='form-group'>
          <label htmlFor='status'>Enter Legal Status</label>
          <input
            type='text'
            name='status'
            id='status'
        ...
        <div className="form-group float-right">
            <a href="/admin/legal-statuses" className="btn btn-danger">Cancel</a>
            <button className="btn btn-primary ml-2" type="submit">Add Legal Status</button>
        </div>
      </form>
    );
  }
